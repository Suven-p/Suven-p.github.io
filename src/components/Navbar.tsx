    ...
    return (
        <>
            <StaticImage
                ...
                alt='Suven Pandey'
                css={[style, tw`hidden dark:block`]}
                objectFit='fill'
            />
            <StaticImage
                src={`../images/icon_light.svg`}
                alt='Suven Pandey'
                css={[style, tw`block dark:hidden`]}
                objectFit='fill'
            />
        </>
    );
            ...
            {links.map(([title, path]) => {
                ...
                return (
                    <Link
                        ...
                        key={title}
                        css={[
                            tw`text-black dark:text-slate-300 visited:text-black`,
                        ]}
...
function Navbar() {
    ...
    return (
        <>
            <label
                tw='block cursor-pointer mx-4 sm:hidden'
                htmlFor='nav-trigger'
            >
                <input
                    type='checkbox'
            ...
            <div
                css={[
                    tw`hidden`,
                    menuExpanded &&
                        tw`flex flex-col gap-2 fixed top-[50px] right-[35px] bg-slate-300 dark:bg-slate-800 rounded-sm z-50 pl-2 pr-4`,
                    tw`sm:(flex flex-row gap-4 static bg-transparent dark:bg-transparent rounded-none p-0)`,
                ]}
            >
                <Links links={links} />
            </div>
        ...
        >
            ...
            <nav tw='flex items-center gap-4'>
                ...
                <label
                    ...
                    css={[tw`relative w-[${toggleWidth}] h-[${toggleHeight}]`]}
                >
                    <input
                        type='checkbox'
                        checked={isDarkMode}
